...
namespace EmployeeMicroservice.Migrations
{
    ...
    [Migration("20220714090408_inital-1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeMicroservice.Database.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EmployeeMicroservice.Database.Entities.Offer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EmployeeMicroservice.Database.Entities.Offer_Category", b =>
                {
            ...
            modelBuilder.Entity("EmployeeMicroservice.Database.Entities.Comment", b =>
                {
                    b.HasOne("EmployeeMicroservice.Database.Entities.Offer", null)
            ...
            modelBuilder.Entity("EmployeeMicroservice.Database.Entities.Offer", b =>
                {
                    b.HasOne("EmployeeMicroservice.Database.Entities.Offer_Category", "Offer_Category")
                        .WithMany()
